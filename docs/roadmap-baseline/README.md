...
| 2 | [02-schema.md](02-schema.md) | 272 tables with current/target owner |
| 3 | [03-routes.md](03-routes.md), [04-cross-service.md](04-cross-service.md) | 1052 routes; 61 cross-service call sites |
...
|  | Criterion | Result |
|---|---|---|
| pass | Every table has an owner classification | 272 tables classified, 0 unclassified |
| pass | Every route is attributed to a repo and source line | 1052 routes; 0 router mounts whose module could not be resolved (their routes are listed without the mount prefix) |
| pass | Every background job is listed with its location | 85 timers/jobs |
| pass | Every cross-service call records caller, callee, auth, timeout and retry | 61 call sites; 23 with no timeout detected |
