...
const PINNED = {
    ...
    tips: 'internal', vip: 'internal', openre: 'internal', search: 'internal', sources: 'internal', chat: 'internal', ai: 'internal',
    sdk: 'library', shared: 'library', contracts: 'library',
    examples: 'repository',
    realtime: 'placeholder',
};
const PLACEHOLDER_DOMAINS = ['news', 'reviews', 'deals', 'coupons', 'trade', 'host', 'tips', 'vip', 'openre', 'search', 'sources'];
...
(async () => {
    ...
    assert.deepStrictEqual(st.exposure_summary, { live: 12, internal: 13, library: 3, repository: 1, placeholder: 1 });
