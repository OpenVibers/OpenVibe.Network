...
const RAW_SITES = [
    ...
    { id: 'chat', name: 'Chat', icon: 'chat', service: 'chat', profile: 'ugc', tagline: 'One chat for the network', what: 'Global chat, rooms, stream chat and direct messages under one account, with or without JavaScript.' },
